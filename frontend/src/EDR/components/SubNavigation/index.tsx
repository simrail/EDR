...
const SubNavigation: React.FC<SubNavigationProps> = (props) => {
    ...
    return (
        <div className="bg-slate-100 dark:bg-gray-900 px-2 py-2.5 dark:border-gray-700 dark:bg-gray-800 sm:px-4 sticky top-20 columns-3 justify-center flex z-10">
