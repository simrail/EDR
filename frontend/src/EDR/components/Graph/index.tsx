...
const Graph: React.FC<Props> = (props) => {
    const {serverTzOffset, timetable, post, serverCode} = props;
    const {isOpen, onClose} = props;
    const graphBody = <GraphContent serverTzOffset={serverTzOffset} timetable={timetable} post={post} serverCode={serverCode}/>
