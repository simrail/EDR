...
export const SelectMenuLayout: React.FC<Props & SubNavigationProps> = ({children, title, isWebpSupported, navPreviousItem, navCurrentItem, navNextItem, serverCode}) => {
    ...
    return <div className="text-primary">
        ...
        <div style={{backgroundImage: "url('"+background+"')", backgroundSize: "cover"}} className="bg-fixed min-h-screen">
        ...
        <div className="text-center p-4">
            {t("FOOTER_version")} 2.7 - {t("FOOTER_screenshots_by")} MilanSVK - {t("FOOTER_thanks")} ❤️ - {t("FOOTER_not_official")}
        </div>
    </div>;
}
